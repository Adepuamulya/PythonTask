...
# ------------------------------------------------------------
# ✅ Replace YOUR_ACTUAL_PASSWORD with the password you set in Atlas
MONGO_URL = "mongodb+srv://adepuamulya04_db_user:amulya04@cluster0.qkafmsb.mongodb.net/todo_db?retryWrites=true&w=majority"
 
connect(host=MONGO_URL)   # ✅ db name already in the URL, no need to pass separately
